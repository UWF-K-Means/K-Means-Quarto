...
::: {.absolute .fragment bottom="100" right="100"}
![centroids](centroids.png){fig-alt=" k=4, the seed point are green, forming 4 respective clusters"} {.absolute top="170" left="30" width="400" height="400"}
:::
...
![clusters](clusters.png){fig-alt="data points reassigned to centroids"}{.absolute top="170" left="30" width="400" height="400"}
:::
