...
3.  Assign each object to the cluster with the nearest assigned centroid. @fig-centroids shows the Euclidean distance calculation as a line connecting each observation to one of the 4 centroids. @fig-centroids
