...
In summary the steps are 1. Establish 'k'(a number of clusters) and start by randomly marking a location in the data set to represent a central reference point.
