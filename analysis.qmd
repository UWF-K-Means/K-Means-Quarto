...
We can see that an overwhelming amount of data comes from the UK which could skew the data during further analysis.
In order to avoid this issue, we will create a separate data set that excludes the UK altogether, then we can compare results and see what differences there may be.
