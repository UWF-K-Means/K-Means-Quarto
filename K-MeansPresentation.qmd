...
::: incrimental
::: {.absolute bottom="130" left="30" width="450" height="300"}
...
The YAML parse error occurs in the steps below. Address these lines to resolve error:
...
-   By increasing the number of clusters, $k$, the inflection point of the curve finds the reduced sum of within-cluster variance.
...
![ElbowMethod](ElbowMethod.png){absolute bottom="80" left="30" width="50" height="50"}
:::
...
![Data Grouped by CustomerID](customerdata.png)
:::

---
::: nonincrimental
::: {.panel-tabset} Structure

### Top 10 Countries
![Top 10 Countries](countires.png)

### Average Sales
![max and min Average Sales by CustomerID](Top5avgsales.png)

### Total Sales
![max and min total Sales by CustomerID](top5total.png)

### Customer Order Frequency
![Top 5 CustomerID's by Order Frequency](Top5OrderCount.png)
:::
:::
---
::: incrimental
...
A subset of data is generated which excludes data associated with the UK to avoid all of the data being from one Country.
:::
